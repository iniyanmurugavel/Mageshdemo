...
public class FireChatUsers extends AppCompatActivity {
    ListView usersList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fire_chat_users);
        ...
        pd = new ProgressDialog(FireChatUsers.this);
        ...
        RequestQueue rQueue = Volley.newRequestQueue(FireChatUsers.this);
        rQueue.add(request);
        ...
        usersList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                startActivity(new Intent(FireChatUsers.this, FireChatChat.class));
            }
        });
    }
